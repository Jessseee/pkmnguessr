/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 51edbb75dac1892e6df543d3214f985a)
// Runtime types generated with workerd@1.20260617.1 2026-06-09 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	ASSETS: Fetcher;
	PUBLIC_ASSETS_DOMAIN: string;
	PUBLIC_SITE_DOMAIN: string;
	PUBLIC_MAX_GUESSES: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ASSETS_DOMAIN" | "PUBLIC_SITE_DOMAIN" | "PUBLIC_MAX_GUESSES">> {}
}
